...
class testSDC(unittest.TestCase):
    ...
    def test_3677(self):
        ...
        self.driver.find_element(By.LINK_TEXT, "Start").click()
        time.sleep(waitToLoad*5)
        self.driver.find_element_by_id("cboBrand").send_keys('HYGOOD')
        time.sleep(waitToLoad*5)
        self.driver.find_element_by_id("cboSystype").send_keys('iFlow System')
        time.sleep(waitToLoad*5)
        self.driver.find_element_by_id("cboSysApproval").send_keys('LPCB (CE)')
        time.sleep(waitToLoad)
        self.driver.find_element_by_id("cboAgenttype").send_keys('IG-541 (Inergen)')
        time.sleep(waitToLoad)
        self.driver.find_element_by_id("cboDesignStandards").send_keys('VdS 2380')
        time.sleep(waitToLoad)
        self.driver.find_element_by_id("cboFireClasses").send_keys('Surface Class A')
        time.sleep(waitToLoad)
        self.driver.find_element_by_id("cboSystemPressures").send_keys('300 bar')
        time.sleep(waitToLoad)
        self.driver.find_element_by_id("cboContainerApproval").send_keys('TPED')
        time.sleep(waitToLoad)
        self.driver.find_element_by_id("cboMulti").send_keys('Selector Valve')
        time.sleep(waitToLoad)
        self.driver.find_element(By.CSS_SELECTOR, "td:nth-child(2) > .btn").click()
        time.sleep(waitToLoad)
        self.vars["window_handles"] = self.driver.window_handles
